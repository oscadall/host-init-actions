...
{
    public interface IInitStageActionCollection
    {
        /// <summary>
        /// Registers a new initialization action to the stage.
        /// </summary>
        ...
        IInitStageActionCollection AddInitAction<TService>(
        ...
        /// <param name="initializationAction">Initialization action.</param>
        /// <returns>Collection for registering initialization actions.</returns>
        IInitStageActionCollection AddInitAction<TService1, TService2>(
        ...
        /// <param name="initializationAction">Initialization action.</param>
        /// <returns>Collection for registering initialization actions.</returns>
        IInitStageActionCollection AddInitAction<TService1, TService2, TService3>(
        ...
        /// <param name="initializationAction">Initialization action.</param>
        /// <returns>Collection for registering initialization actions.</returns>
        IInitStageActionCollection AddInitAction<TService1, TService2, TService3, TService4>(
        ...
        /// <param name="initializationAction">Initialization action.</param>
        /// <returns>Collection for registering initialization actions.</returns>
        IInitStageActionCollection AddInitAction<TService1, TService2, TService3, TService4, TService5>(
        ...
        /// <summary>
        /// Registers a class that performs the initialization action in this stage.
        /// </summary>
